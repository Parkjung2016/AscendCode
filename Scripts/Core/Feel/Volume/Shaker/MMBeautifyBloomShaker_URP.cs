...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    [AddComponentMenu("More Mountains/Feedbacks/Shakers/PostProcessing/MMBeautifyBloomShaker_URP")]
    public class MMBeautifyBloomShaker_URP : MMShaker
    {
        ...
        {
            _initialIntensity = _beautify.bloomIntensity.value;
            _initialThreshold = _beautify.bloomThreshold.value;
        }
        ...
        protected override void ResetTargetValues()
        {
            ...
            _beautify.bloomIntensity.Override(_initialIntensity);
            _beautify.bloomThreshold.Override(_initialThreshold);
        }
        ...
        {
            base.StartListening();
            MMBeautifyBloomShakeEvent_URP.Register(OnBloomShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMBeautifyBloomShakeEvent_URP.Unregister(OnBloomShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMBeautifyBloomShakeEvent_URP
    {
