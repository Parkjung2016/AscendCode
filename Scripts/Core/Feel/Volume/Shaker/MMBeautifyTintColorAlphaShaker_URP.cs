...
{
    public class MMBeautifyTintColorAlphaShaker_URP : MMShaker
    {
        public bool RelativeValues = true;

        [MMInspectorGroup("TintColor Alpha", true, 51)]
        ...
        {
            _initialAlpha = _beautify.tintColor.value.a;
        }
        ...
        {
            base.StartListening();
            MMBeautifyTintColorAlphaShakeEvent_URP.Register(OnBloodScreenShakeEvent);
        }
        ...
        {
            base.StopListening();
            MMBeautifyTintColorAlphaShakeEvent_URP.Unregister(OnBloodScreenShakeEvent);
        }
    }
    ...
    /// </summary>
    public struct MMBeautifyTintColorAlphaShakeEvent_URP
    {
